...
async def handle_receipt(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    admin_msg = f"🔔 **New Payment**\nUser: {user.id}\nPkg: {context.user_data.get('pending_pkg')}\n\n{update.message.text}"
    btns = InlineKeyboardMarkup([[InlineKeyboardButton("✅ Approve", callback_data=f"appr_{user.id}_{context.user_data.get('pending_pkg')}"), 
